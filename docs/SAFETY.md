...
| Never enter a password, create an account, or handle credentials | `01_job_grabber.md` §0.2 · `02_job_applier.md` §0.3, §6.2 |
...
| Never apply on an ATS requiring account creation | `01_job_grabber.md` §4.2 · `02_job_applier.md` §6.2 |
...
| Application login wall | Job skipped as `Requires Account Creation` and logged |
